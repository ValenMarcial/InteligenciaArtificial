...
def main():
  random.seed(42)
  pop = toolbox.population(n=42) #Tamaño 50 de la poblacion
  ...
  algorithms.eaSimple(pop, toolbox, cxpb=0.5, mutpb=0.2, ngen=100, stats=stats, halloffame=hof, verbose=True) #selección → cruce → mutación → evaluación, repetido ngen veces
